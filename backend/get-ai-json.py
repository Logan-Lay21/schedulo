...
prompt_template = ChatPromptTemplate.from_messages([
    ("system", """Extract scheduling details into a Google Calendar event JSON object only respond with valid json, don't include comments about the json:
        {{
